  ...
  return (
    <div className="flex flex-row">
      <form className="w-1/2 p-4">
        ...
        <button
          className="bg-blue hover:bg-deep-blue text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
          type="submit"
      ...
      <div className="w-1/2 p-4 bg-opaque-black text-white">
